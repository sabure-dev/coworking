...
function MyProjectPage() {
    ...
    const getProjects = async () => {
        const response = await fetch('https://e6fe3a5b-d159-474e-a49f-6cfa07975b67.tunnel4.com/api/project/my', {
            method: 'GET', headers: {
    ...
    const handleDelete = async (id) => {
        try {
            const response = await fetch(`https://e6fe3a5b-d159-474e-a49f-6cfa07975b67.tunnel4.com/api/project/${id}`, {
    ...
    const getFile = async (id, filename) => {
        try {
            const response = await fetch(`https://e6fe3a5b-d159-474e-a49f-6cfa07975b67.tunnel4.com/api/project/${id}/files/`, {
                method: 'GET',
                headers: {
                    "Authorization": `bearer ${token}`
                },
